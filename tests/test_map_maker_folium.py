...
from map_maker.folium.map_maker import (
    make_map_plot,
    _get_tooltip_keys,
    _get_tooltip_values,
)
...
def test_get_tooltip_keys():
    """ Tests that the _get_tooltip_keys function returns the correct value.
    """
    shape_datum = {
        "shape": "a",
        "shape_obj": "b",
    ...
    truth = ["x", "y"]
    answer = _get_tooltip_keys(shape_datum)

    assert sorted(truth) == sorted(answer)


def test_get_tooltip_values():
    """ Tests that the _get_tooltip_values function returns the correct value.
    """
    shape_datum = {
        "shape": "a",
        "shape_obj": "b",
    ...
    truth = ["x: 1", "y: 2"]
    answer = _get_tooltip_values(shape_datum)
